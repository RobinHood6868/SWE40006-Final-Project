      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Khám phá sản phẩm tại đây</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Chúng tôi có {products?.length || 0} những sản phẩm công nghệ đa dạng, từ điện thoại, laptop đến phụ kiện và thiết bị gaming
            </p>
          </div>
